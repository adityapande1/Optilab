...
class StrangleWeekly(Strategy):
    ...
    def about(self) -> str:
        ...
        about_str += f'Enter a Strangle right [ NEXT DAY OF EXPIRY ] of nearest OTM strikes at {self.config.entry_time.strftime("%H:%M:%S")} at close of underlying.\n'
