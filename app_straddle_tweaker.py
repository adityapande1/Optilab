...
def run():
    ...
    if selected_CRPR is not None:
        selected_foldercode = _generate_foldercode(
            entry_time=selected_entry_time,
            exit_time=selected_exit_time,
            call_risk=selected_CRPR[0],
            put_risk=selected_CRPR[1],
            trail_risk=selected_trail_risk
        )
